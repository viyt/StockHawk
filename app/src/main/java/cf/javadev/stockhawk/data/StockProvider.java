...
public class StockProvider extends ContentProvider {
    ...
    private static final int HISTORY_FOR_SYMBOL = 103;
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(Contract.AUTHORITY, Contract.PATH_HISTORY_WITH_SYMBOL, HISTORY_FOR_SYMBOL);
        return matcher;
    }
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case HISTORY_FOR_SYMBOL:
                returnCursor = db.query(
                        Contract.History.TABLE_NAME,
                        projection,
                        Contract.History.COLUMN_SYMBOL+ " = ? ",
                        new String[]{Contract.History.getStockFromUri(uri)},
                        null,
                        null,
                        sortOrder
                );
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case HISTORY:
                ...
                break;
            case HISTORY_FOR_SYMBOL:
                String symbol1 = Contract.History.getStockFromUri(uri);
                rowsDeleted = db.delete(
                        Contract.History.TABLE_NAME,
                        '"' + symbol1 + '"' + " =" + Contract.History.COLUMN_SYMBOL,
                        selectionArgs
                );
                break;
            default:
